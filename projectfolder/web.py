...
def serve_image(timestamp):
    ...
    return send_from_directory('/home/pi/teknobil/projectfolder', 'image.jpg')
...
# Change from "pi" to "teknostart
model = ImageModel.load('/home/pi/teknobil/Lobe')

def compare():
    with image_lock:
        # Change from "pi" to "teknostart"
        res = model.predict_from_file('/home/pi/teknobil/projectfolder/image.jpg')
    ...
    def do_GET(self):
        if self.path == '/':
            ...
            try:
                ...
                # Change from "pi" to "teknostart"
                text_file = open('/home/pi/teknobil/projectfolder/result.txt', "w")
